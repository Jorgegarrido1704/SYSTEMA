...
class juntasController extends Controller
{
    ...
    public function addVacation(Request $request)
    {
        ...
        if ($lider == 'GUILLEN MIRANDA JUAN JOSE' or $lider == 'AGUILAR HERNANDEZ ANA PAOLA' or $lider == 'RAMOS CEDEÑO LUIS ALBERTO'
            ...
            or $lider == 'GUTIERREZ MARTINEZ DANIEL EMMANUEL' or $lider = 'GONZALEZ CHAVEZ ANGEL DE JESUS'
            or $lider == 'Jorge Arturo Garrido Mares'
        ) {
    ...
    public function rhDashBoard()
    {
        ...
        $disponibilidadPrimesTurno = $disponibilidadPrimesTurno1->disponibilidad ?? 0;
    ...
    public function npi()
    {
        ...
        */
        ...
        $totalgenppap = $totalgeneral[0]->ppap ?? 0;
        $totalgenprim = $totalgeneral[0]->prim ?? 0;
        $inprogresppap = $inprogres[0]->ppap ?? 0;
        $inprogresprim = $inprogres[0]->prim ?? 0;
