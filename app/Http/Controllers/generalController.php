        ...
        if(empty($buscarCantidad)){ $resp="Recod not found";}
            ...
            $update = DB::table('registroparcial')->where('codeBar', "=",$codigo)->update(['loomPar' => '0','eng' => $loomPar]);
                     ...
                     if(($donde==='loom' and $count===9) or ($donde==='loom' and $loomPar>0 and $count!==8)){
                        ...
                        $noloom=['910985','910987','91304','90863','90843','90844','910966','911031','91318','60744','60745','91267','910958','91277','90833','910988',
                            '910992','90836','91315','920628','40742','90943','910956','40741','91175','91164','910980','910982','90834','910508','91194','
                            90835','91583','910968','910350','910651','911028','91195','910886','910965','910962','910824','910887','910964','910659','40304',
                            '91222','91518','91518-1','910957','91135','910974','910577','91138','91221','910792','910978','90841','90842','910908','910910',
                            '910444','91525','910981','910967','40601','91211','91682','910621','90798','91517','91516','91681','91133','91212','91224','910975',
                            '910325','910347','910907','910909','910979','910326','910960','91137','910511','910821','910940','91139','90839','90877','91223',
                            '910912','61522','90838','910911','91136','910390','910668','910400','910410','910955','90837','910953','90840','910678','910914',
                            '40199','40200','910971','910399','910969','91165','910661','40488','910972','40640','40599','910411','910913','91177','910973',
                            '40639','910954','910348','910650','911022','40602','91162','91163','910666','40600','910951','91176','910349','911024','910984',
                            ...
                            '910664','910735','910512','910513','40747','90894','90919','90941'
                        ];
                        if(in_array($pnReg,$noloom)){
                            if( $cantidad<($ensaPar) and (substr($rev,0,4)!='PRIM' or substr($rev,0,4)!='PPAP' )){
                                $restoAnt=$ensaPar-$cantidad;             $nuevo=$preCalidad+$cantidad;
                        ...
                        if( $cantidad<$cortPar and (substr($rev,0,4)!='PRIM' or substr($rev,0,4)!='PPAP' )){
                            $restoAnt=$cortPar-$cantidad;      $nuevo=$libePar+$cantidad;
                            ...
                            $restoAnt=0; $nuevo=$libePar+$cortPar;
                            $update = DB::table('registroparcial')->where('codeBar', "=",$codigo)->update(['cortPar'=> $restoAnt,'libePar' => $nuevo]);
